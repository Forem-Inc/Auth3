...
public:
    ServerSetup() {
        ...
        drogon::app()
        .registerHandler("/create-service", &AuthServer::create_service, {Post});
        drogon::app()
        .registerHandler("/login-in-service", &AuthServer::login_at_service, {Post});
        drogon::app()
        .registerHandler("/create-user", &AuthServer::create_user, {Post});
